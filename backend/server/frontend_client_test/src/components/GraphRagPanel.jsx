...
export function GraphRagPanel({ config, request }) {
  ...
  const clearIndexesResponse = useCallback(() => setIndexesResponse(null), [])
  const clearCreateIndexResponse = useCallback(() => setCreateIndexResponse(null), [])
  const clearDeleteIndexResponse = useCallback(() => setDeleteIndexResponse(null), [])
  const clearDocumentsResponse = useCallback(() => setDocumentsResponse(null), [])
  const clearNewDocumentResponse = useCallback(() => setNewDocumentResponse(null), [])
  const clearUpdateDocumentResponse = useCallback(() => setUpdateDocumentResponse(null), [])
  const clearDeleteDocumentResponse = useCallback(() => setDeleteDocumentResponse(null), [])
  const clearMetadataResponse = useCallback(() => setMetadataResponse(null), [])
  const clearSearchResponse = useCallback(() => setSearchResponse(null), [])
      ...
      <TabsContent value="indexes" className="space-y-6">
        <Card as="section">
          ...
          <CardContent className="space-y-6">
            ...
            <ResponseViewer title="Create index" scope="graph" response={createIndexResponse} onClear={clearCreateIndexResponse} />
            ...
            <ResponseViewer title="Delete index" scope="graph" response={deleteIndexResponse} onClear={clearDeleteIndexResponse} />
          </CardContent>
        </Card>
        ...
        <Card as="section">
          ...
          <CardContent>
            ...
            <ResponseViewer title="List indexes" scope="graph" response={indexesResponse} onClear={clearIndexesResponse} />
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="documents" className="space-y-6">
        <Card as="section">
          ...
          <CardContent>
            ...
            <ResponseViewer title="Fetch documents" scope="graph" response={documentsResponse} onClear={clearDocumentsResponse} />
          </CardContent>
        </Card>
...
{'}'}]</pre>
            ...
            <ResponseViewer title="Create document" scope="graph" response={newDocumentResponse} onClear={clearNewDocumentResponse} />
            ...
            <ResponseViewer title="Update document" scope="graph" response={updateDocumentResponse} onClear={clearUpdateDocumentResponse} />
            ...
            <ResponseViewer title="Delete document" scope="graph" response={deleteDocumentResponse} onClear={clearDeleteDocumentResponse} />
          </CardContent>
        </Card>
        ...
        <Card as="section">
          ...
          <CardContent>
            ...
            <ResponseViewer title="Fetch metadata" scope="graph" response={metadataResponse} onClear={clearMetadataResponse} />
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="search" className="space-y-6">
        <Card as="section">
          ...
          <CardContent>
            ...
            <ResponseViewer title="Search" scope="graph" response={searchResponse} onClear={clearSearchResponse} />
          </CardContent>
        </Card>
      </TabsContent>
    </Tabs>
